...
public class AuthorityServiceImpl extends ServiceImpl<AuthorityMapper, Authority> implements AuthorityService {
    ...
    @Override
    public int updateAllFieldsById(Authority entity) {
    ...
    @Override
    public boolean saveBatch(Collection<Authority> entityList, int batchSize) {
        String sqlStatement = SqlHelper.getSqlStatement(AuthorityBaseMapper.class, SqlMethod.INSERT_ONE);

...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`sys_staff_research_leader`")
@ApiModel(value = "StaffResearchLeader", description = "教研组长表")
public class StaffResearchLeader extends BaseDomain {
    /**
     * ID系统自动生成
     */
     ...
     * 设置默认值
     */
    public StaffResearchLeader setDefault() {
        return this;
    }

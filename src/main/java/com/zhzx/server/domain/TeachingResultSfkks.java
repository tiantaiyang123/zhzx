...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`tmg_teaching_result_sfkks`")
@ApiModel(value = "TeachingResultSfkks", description = "示范课、研究课开设表")
public class TeachingResultSfkks extends BaseDomain {
    /**
     * ID系统自动生成
     */
     ...
     * 设置默认值
     */
    public TeachingResultSfkks setDefault() {
        return this;
    }

...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`tmg_teaching_result_lzcb`")
@ApiModel(value = "TeachingResultLzcb", description = "论著出版表")
public class TeachingResultLzcb extends BaseDomain {
    /**
     * ID系统自动生成
     */
     ...
     * 设置默认值
     */
    public TeachingResultLzcb setDefault() {
        return this;
    }

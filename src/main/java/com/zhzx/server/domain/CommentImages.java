...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`day_comment_images`")
@ApiModel(value = "CommentImages", description = "意见与建议照片表")
public class CommentImages extends BaseDomain {
    /**
     * ID系统自动生成
     */
     ...
     * 设置默认值
     */
    public CommentImages setDefault() {
        return this;
    }

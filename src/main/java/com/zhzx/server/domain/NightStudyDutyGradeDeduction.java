...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`day_night_study_duty_grade_deduction`")
@ApiModel(value = "NightStudyDutyGradeDeduction", description = "晚自习行政值班年级扣分表(不用)")
public class NightStudyDutyGradeDeduction extends BaseDomain {
    /**
     * ID系统自动生成
     */
     ...
     * 设置默认值
     */
    public NightStudyDutyGradeDeduction setDefault() {
        return this;
    }

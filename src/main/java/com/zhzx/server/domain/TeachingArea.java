...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`day_teaching_area`")
@ApiModel(value = "TeachingArea", description = "教学区秩序表")
public class TeachingArea extends BaseDomain {
    /**
     * ID系统自动生成
     */
    ...
    @TableField(exist = false)
    private List<TeachingAreaImages> teachingAreaImagesList;
    /**
     ...
     * 高一年级教学区秩序
     */
    @TableField(value = "teaching_area_order1")
    @ApiModelProperty(value = "高一年级教学区秩序", required = true)
    private DayOrderEnum teachingAreaOrder1;
    /**
     * 高二年级教学区秩序
     */
    @TableField(value = "teaching_area_order2")
    @ApiModelProperty(value = "高二年级教学区秩序", required = true)
    private DayOrderEnum teachingAreaOrder2;
    /**
     * 高三年级教学区秩序
     */
    @TableField(value = "teaching_area_order3")
    @ApiModelProperty(value = "高三年级教学区秩序", required = true)
     ...
     * 设置默认值
     */
    public TeachingArea setDefault() {
        if (this.getTeachingAreaOrder1() == null) {
            this.setTeachingAreaOrder1(DayOrderEnum.NORMAL);
        }
        if (this.getTeachingAreaOrder2() == null) {
            this.setTeachingAreaOrder2(DayOrderEnum.NORMAL);
        }
        if (this.getTeachingAreaOrder3() == null) {
            this.setTeachingAreaOrder3(DayOrderEnum.NORMAL);
        }
    ...
    public Boolean validate(Boolean throwException) {
        ...
        if (this.getTeachingAreaOrder1() == null) {
            if (throwException) throw new ApiCode.ApiException(-1, "高一年级教学区秩序不能为空！");
            return false;
        }
        if (this.getTeachingAreaOrder2() == null) {
            if (throwException) throw new ApiCode.ApiException(-1, "高二年级教学区秩序不能为空！");
            return false;
        }
        if (this.getTeachingAreaOrder3() == null) {
            if (throwException) throw new ApiCode.ApiException(-1, "高三年级教学区秩序不能为空！");
            return false;
        }

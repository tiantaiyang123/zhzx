...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`tmg_teaching_result_grry`")
@ApiModel(value = "TeachingResultGrry", description = "个人荣誉表")
public class TeachingResultGrry extends BaseDomain {
    /**
     * ID系统自动生成
     */
     ...
     * 设置默认值
     */
    public TeachingResultGrry setDefault() {
        return this;
    }

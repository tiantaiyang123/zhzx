...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`dat_exam_goal_natural_template`")
@ApiModel(value = "ExamGoalNaturalTemplate", description = "考试赋分模板表")
public class ExamGoalNaturalTemplate extends BaseDomain {
    /**
     * ID系统自动生成
     */
     ...
     * 设置默认值
     */
    public ExamGoalNaturalTemplate setDefault() {

...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`day_night_sport_area`")
@ApiModel(value = "NightSportArea", description = "晚班运动区秩序表")
public class NightSportArea extends BaseDomain {
    /**
     * ID系统自动生成
     */
    ...
    @TableField(exist = false)
    private List<NightSportAreaImages> nightSportAreaImagesList;
    /**
     ...
     * 设置默认值
     */
    public NightSportArea setDefault() {

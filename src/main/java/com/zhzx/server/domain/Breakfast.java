...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`day_breakfast`")
@ApiModel(value = "Breakfast", description = "早餐情况表")
public class Breakfast extends BaseDomain {
    /**
     * ID系统自动生成
     */
    ...
    @TableField(exist = false)
    private List<BreakfastImages> breakfastImagesList;
    /**

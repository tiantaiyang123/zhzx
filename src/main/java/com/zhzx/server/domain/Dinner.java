...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`day_dinner`")
@ApiModel(value = "Dinner", description = "晚餐情况表")
public class Dinner extends BaseDomain {
    /**
     * ID系统自动生成
     */
    ...
    @TableField(exist = false)
    private List<DinnerImages> dinnerImagesList;
    /**

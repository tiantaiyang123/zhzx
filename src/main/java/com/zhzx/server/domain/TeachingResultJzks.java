...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`tmg_teaching_result_jzks`")
@ApiModel(value = "TeachingResultJzks", description = "讲座开设表")
public class TeachingResultJzks extends BaseDomain {
    /**
     * ID系统自动生成
     */
     ...
     */
    @TableField(value = "jzmc")
    @ApiModelProperty(value = "讲座名称 和tmg_teaching_result.name一致", required = true)
    private String jzmc;
    /**
     * 组织单位
     */
     ...
     * 设置默认值
     */
    public TeachingResultJzks setDefault() {
        return this;
    }
    ...
    public Boolean validate(Boolean throwException) {
        ...
        if (this.getJzmc() == null) {
            if (throwException) throw new ApiCode.ApiException(-1, "讲座名称 和tmg_teaching_result.name一致不能为空！");
            return false;
        }

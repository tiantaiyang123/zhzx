...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`sys_staff_grade_leader`")
@ApiModel(value = "StaffGradeLeader", description = "年级组长表")
public class StaffGradeLeader extends BaseDomain {
    /**
     * ID系统自动生成
     */
     ...
     * 设置默认值
     */
    public StaffGradeLeader setDefault() {
        return this;
    }

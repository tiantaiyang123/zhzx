...
@NoArgsConstructor
@AllArgsConstructor
@TableName("`sys_teaching_result_declaration_classify`")
@ApiModel(value = "TeachingResultDeclarationClassify", description = "教学成果参评申报类别表")
public class TeachingResultDeclarationClassify extends BaseDomain {
    /**
     * ID系统自动生成
     */
    ...
    private TeachingResultDeclarationClassify parent;
    /**
     * 序号
     */
     ...
     * 设置默认值
     */
    public TeachingResultDeclarationClassify setDefault() {

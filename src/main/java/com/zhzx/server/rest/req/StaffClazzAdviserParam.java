...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "班主任表参数", description = "")
public class StaffClazzAdviserParam implements Serializable {
    /**
     * ID系统自动生成
     */
     ...
     * 将查询参数转化为查询Wrapper
     */
    public QueryWrapper<StaffClazzAdviser> toQueryWrapper() {
        QueryWrapper<StaffClazzAdviser> wrapper = Wrappers.<StaffClazzAdviser>query();

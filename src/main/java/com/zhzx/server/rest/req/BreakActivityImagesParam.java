...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "大课间活动情况照片表参数", description = "")
public class BreakActivityImagesParam implements Serializable {
    /**
     * ID系统自动生成
     */
     ...
     */
    @ApiModelProperty(value = "大课间活动情况ID day_break_activity.id")
     ...
     * 将查询参数转化为查询Wrapper
     */
    public QueryWrapper<BreakActivityImages> toQueryWrapper() {
        QueryWrapper<BreakActivityImages> wrapper = Wrappers.<BreakActivityImages>query();
        wrapper.eq(this.getId() != null, "id", this.getId());
        wrapper.in(this.getIdList() != null && this.getIdList().size() > 0, "id", this.getIdList());
        wrapper.eq(this.getBreakActivityId() != null, "break_activity_id", this.getBreakActivityId());
        if (this.getUrl() != null) {

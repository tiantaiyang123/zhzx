...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "教学区秩序照片表参数", description = "")
public class TeachingAreaImagesParam implements Serializable {
    /**
     * ID系统自动生成
     */
     ...
     */
    @ApiModelProperty(value = "教学区秩序ID day_teaching_area.id")
     ...
     * 将查询参数转化为查询Wrapper
     */
    public QueryWrapper<TeachingAreaImages> toQueryWrapper() {
        QueryWrapper<TeachingAreaImages> wrapper = Wrappers.<TeachingAreaImages>query();
        wrapper.eq(this.getId() != null, "id", this.getId());
        wrapper.in(this.getIdList() != null && this.getIdList().size() > 0, "id", this.getIdList());
        wrapper.eq(this.getTeachingAreaId() != null, "teaching_area_id", this.getTeachingAreaId());

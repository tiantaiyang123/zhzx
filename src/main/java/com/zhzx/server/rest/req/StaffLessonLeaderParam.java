...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "备课组长表参数", description = "")
public class StaffLessonLeaderParam implements Serializable {
    /**
     * ID系统自动生成
     */
     ...
     * 将查询参数转化为查询Wrapper
     */
    public QueryWrapper<StaffLessonLeader> toQueryWrapper() {
        QueryWrapper<StaffLessonLeader> wrapper = Wrappers.<StaffLessonLeader>query();

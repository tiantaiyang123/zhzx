...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "考试赋分模板表参数", description = "")
public class ExamGoalNaturalTemplateParam implements Serializable {
    /**
     * ID系统自动生成
     */
     ...
     * 将查询参数转化为查询Wrapper
     */
    public QueryWrapper<ExamGoalNaturalTemplate> toQueryWrapper() {
        QueryWrapper<ExamGoalNaturalTemplate> wrapper = Wrappers.<ExamGoalNaturalTemplate>query();

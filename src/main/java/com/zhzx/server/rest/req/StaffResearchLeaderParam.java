...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "教研组长表参数", description = "")
public class StaffResearchLeaderParam implements Serializable {
    /**
     * ID系统自动生成
     */
     ...
     * 将查询参数转化为查询Wrapper
     */
    public QueryWrapper<StaffResearchLeader> toQueryWrapper() {
        QueryWrapper<StaffResearchLeader> wrapper = Wrappers.<StaffResearchLeader>query();

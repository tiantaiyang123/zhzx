...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "考试打印日志表参数", description = "")
public class ExamPrintLogParam implements Serializable {
    /**
     * ID系统自动生成
     */
     ...
     * 将查询参数转化为查询Wrapper
     */
    public QueryWrapper<ExamPrintLog> toQueryWrapper() {
        QueryWrapper<ExamPrintLog> wrapper = Wrappers.<ExamPrintLog>query();

...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "集体荣誉表参数", description = "")
public class TeachingResultJtryParam implements Serializable {
    /**
     * ID系统自动生成
     */
     ...
     */
    @ApiModelProperty(value = "获奖名称 和tmg_teaching_result.name一致")
    private String hjmc;
    /**
     ...
     * 将查询参数转化为查询Wrapper
     */
    public QueryWrapper<TeachingResultJtry> toQueryWrapper() {
        QueryWrapper<TeachingResultJtry> wrapper = Wrappers.<TeachingResultJtry>query();

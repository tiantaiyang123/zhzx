...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "老师科目表参数", description = "")
public class StaffSubjectParam implements Serializable {
    /**
     * ID系统自动生成
     */
     ...
     * 将查询参数转化为查询Wrapper
     */
    public QueryWrapper<StaffSubject> toQueryWrapper() {
        QueryWrapper<StaffSubject> wrapper = Wrappers.<StaffSubject>query();

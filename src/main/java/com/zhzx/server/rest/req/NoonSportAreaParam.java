...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "午班运动区秩序表参数", description = "")
public class NoonSportAreaParam implements Serializable {
    /**
     * ID系统自动生成
     */
     ...
     * 将查询参数转化为查询Wrapper
     */
    public QueryWrapper<NoonSportArea> toQueryWrapper() {
        QueryWrapper<NoonSportArea> wrapper = Wrappers.<NoonSportArea>query();

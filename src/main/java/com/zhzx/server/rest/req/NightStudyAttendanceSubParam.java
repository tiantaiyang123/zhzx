...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "晚自习考勤班级概况表参数", description = "")
public class NightStudyAttendanceSubParam implements Serializable {
    /**
     * ID系统自动生成
     */
     ...
     * 将查询参数转化为查询Wrapper
     */
    public QueryWrapper<NightStudyAttendanceSub> toQueryWrapper() {
        ...
        wrapper.eq(this.getIsFullAttendence() != null, "is_full_attendence", this.getIsFullAttendence());

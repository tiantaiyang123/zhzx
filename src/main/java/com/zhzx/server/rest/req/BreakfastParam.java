...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "早餐情况表参数", description = "")
public class BreakfastParam implements Serializable {
    /**
     * ID系统自动生成
     */
     ...
     * 将查询参数转化为查询Wrapper
     */
    public QueryWrapper<Breakfast> toQueryWrapper() {
        QueryWrapper<Breakfast> wrapper = Wrappers.<Breakfast>query();

...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "论著出版表参数", description = "")
public class TeachingResultLzcbParam implements Serializable {
    /**
     * ID系统自动生成
     */
     ...
     * 将查询参数转化为查询Wrapper
     */
    public QueryWrapper<TeachingResultLzcb> toQueryWrapper() {
        QueryWrapper<TeachingResultLzcb> wrapper = Wrappers.<TeachingResultLzcb>query();
